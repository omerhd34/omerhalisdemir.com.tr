  ...
  >
   <div className="flex justify-center gap-4 xs:gap-6 sm:gap-8">
    <div className="text-center">
     <div className="text-xl xs:text-2xl font-bold text-red-400">{stats.total}</div>
     <div className="text-xs xs:text-sm">
      {language === "TR" ? "Toplam Proje" : "Total Projects"}
     </div>
    </div>
    <div className="text-center">
     <div className="text-xl xs:text-2xl font-bold text-green-400">{stats.completed}</div>
     <div className="text-xs xs:text-sm">
      {language === "TR" ? "Tamamlanan" : "Completed"}
     </div>
    </div>
    <div className="text-center">
     <div className="text-xl xs:text-2xl font-bold text-blue-400">{stats.current}</div>
     <div className="text-xs xs:text-sm">
