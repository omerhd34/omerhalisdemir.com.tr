...
const experienceData = [
 ...
 },
 {
  ...
  gpa: null,
  descriptionTr:
   "Freelance Full Stack Developer olarak, vizyon sahibi müşterilerin fikirlerini modern, ölçeklenebilir ve yüksek performanslı dijital ürünlere dönüştürüyorum. Frontend tarafında React, Next.js ve Tailwind CSS uzmanlığım ile sadece estetik değil, aynı zamanda SEO uyumlu, hızlı yüklenen ve kullanıcı deneyimini (UX) optimize eden arayüzler tasarlıyorum. Backend tarafında ise Node.js ve Express.js mimarisiyle birlikte PostgreSQL, MySQL ve MongoDB veritabanlarını kullanarak, veri bütünlüğünü ve güvenliğini garanti altına alan, yüksek trafikli senaryolara dayanıklı API'ler inşa ediyorum. Bir projeyi sadece teknik bir görev olarak değil, bir iş ortaklığı olarak ele alırım. Karmaşık teknik detayları anlaşılır iş çözümlerine çevirmek ve temiz kod (clean code) prensipleriyle sürdürülebilir sistemler kurmak en güçlü yönlerimdendir. Hızla değişen teknoloji dünyasında sürekli kendimi güncel tutarak, projelerime en yeni araçları ve 'best practice'leri entegre ediyor, müşterilerimin dijital hedeflerine ulaşmasında kritik bir rol oynuyorum.",
  descriptionEn:
   "As a freelance Full Stack Developer, I operate as a strategic digital partner, transforming ambitious ideas into scalable, high-performance web solutions. On the frontend, I leverage my expertise in React, Next.js, and Tailwind CSS to craft pixel-perfect, SEO-friendly interfaces that prioritize superior user experience (UX) and core web vitals. On the backend, I architect robust systems using Node.js and Express.js, integrating PostgreSQL, MySQL and MongoDB to ensure data integrity, security, and the ability to handle complex logic. I view every project not merely as a coding task, but as a collaborative business partnership. My strength lies in bridging the gap between complex technical requirements and tangible business goals, delivering clean, maintainable code strictly on schedule. By staying at the forefront of the rapidly evolving tech landscape, I actively integrate the latest industry standards and modern architecture patterns, ensuring that the solutions I deliver provide a distinct competitive edge to my clients.",
  technologies: [
   "FaHtml5",
   "FaCss3Alt",
   "FaJsSquare",
