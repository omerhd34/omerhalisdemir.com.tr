...
const projectsData = [
  {
    category: "web",
    titleTr: "Boykot Rehberi",
    titleEn: "Boycott Guide",
    descriptionTr:
      "Boykot Rehberi, kullanıcıların boykot edilen markaları kategorilere göre görüntüleyebileceği, boykot gerekçelerini ve alternatif ürünleri/hizmetleri keşfedebileceği bir platformdur. Kullanıcılar, sektörlere göre düzenlenmiş boykot listeleri üzerinden bilinçli tüketim kararları alabilir.",
    descriptionEn:
      "Boycott Guide is a platform where users can view boycotted brands by category, discover boycott reasons and alternative products/services. Users can make conscious consumption decisions through boycott lists organized by industry.",
    longDescriptionTr:
      "Boykot Rehberi, kullanıcıların boykot edilen markaları sektörlere göre görüntüleyebileceği kapsamlı bir web platformudur. Next.js 16 ve React 19 teknolojileri kullanılarak geliştirilmiş bu platform, kullanıcıların boykot edilen markaları kategorilere göre keşfetmesine, boykot gerekçelerini ve kanıtlarını incelemesine, alternatif ürün ve hizmetleri bulmasına olanak tanır. MongoDB veritabanı altyapısı ve Prisma ORM ile güvenli ve ölçeklenebilir bir yapı kurulmuştur. Tailwind CSS ile şekillendirilmiş modern ve responsive tasarım, tüm cihazlarda kullanıcı deneyimi sağlamayı hedefler. Server-side rendering ile SEO optimizasyonu yapılmış, dinamik içerik yönetimi ile kolay güncelleme imkanı sunulmaktadır. Express.js tabanlı API server ile RESTful endpoint'ler sağlanmış, gerçek zamanlı arama fonksiyonu ile marka ve kategori araması yapılabilmektedir. Platform, kullanıcı dostu arayüzü ve güvenli veri yönetimi ile toplumsal farkındalık ve bilinçli tüketim alışkanlıklarını desteklemeyi amaçlar. Proje aktif olarak geliştirilmekte olup, Vercel platformunda yayınlanması planlanmaktadır. Modern deployment yöntemleri ile yönetilecek olan bu platform, kullanıcıların bilinçli tüketim kararları almasına yardımcı olacak araçlar sunmayı hedefler.",
    longDescriptionEn:
      "Boycott Guide is a comprehensive web platform where users can view boycotted brands by industry. This platform, developed using Next.js 16 and React 19 technologies, allows users to discover boycotted brands by category, review boycott reasons and evidence, and find alternative products and services. A secure and scalable structure has been established with MongoDB database infrastructure and Prisma ORM. The modern and responsive design shaped with Tailwind CSS aims to provide a good user experience across all devices. SEO optimization has been implemented with server-side rendering, and dynamic content management offers easy update capabilities. An Express.js-based API server provides RESTful endpoints, enabling real-time search functionality for brands and categories. The platform aims to support social awareness and conscious consumption habits with its user-friendly interface and secure data management. The project is actively under development and is planned to be published on the Vercel platform. This platform, which will be managed through modern deployment methods, aims to provide tools that help users make conscious consumption decisions.",
    status: "current",
    technologies: [
      "SiNextdotjs",
      "SiReact",
    ...
    featuresTr: [
      "Kategorilere göre marka listeleme",
      "Marka detay sayfaları (boykot gerekçeleri, alternatifler)",
    ...
    featuresEn: [
      "Brand listing by categories",
      "Brand detail pages (boycott reasons, alternatives)",
    ...
    metricsTr: [
      ...
      { label: "Listelenen Marka Sayısı", value: "" },
    ],
    metricsEn: [
      { label: "Development Time", value: "" },
      { label: "Number of Listed Brands", value: "" },
    ],
    displayOrder: 1,
  },
  {
