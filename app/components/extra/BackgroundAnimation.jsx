...
export default function BackgroundAnimation() {
 ...
 const checkCollision = (newPos, existingPositions, minDistance = 15) => {
 ...
 const generateSafePositions = (count, elementType) => {
  const positions = [];
    ...
    return (
     <div
      ...
      style={{
       left: `${position.x}%`,
       top: `${position.y}%`,
       color: `rgba(${120 + Math.random() * 135}, ${160 + Math.random() * 95
        }, ${210 + Math.random() * 45}, ${typeof window !== "undefined" && window.innerWidth < 640
         ? 0.15
