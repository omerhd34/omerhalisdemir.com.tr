    ...
    <div className="flex justify-center mr-3 ">
      <div className="inline-block relative">
        <div className="relative">
          <div
            className={`animated-gradient w-10 h-10 rounded-full relative overflow-hidden shadow-xl transition-all duration-500 ${
          ...
          >
            {/* Üst katman efekt */}
            <div
              className={`absolute inset-0 opacity-30 mix-blend-overlay bg-gradient-to-r from-transparent via-white to-transparent transition-opacity duration-300 ${
                isHovered ? "opacity-50" : "opacity-30"
              }`}
            ></div>

            <div
              className={`particle particle-1 absolute bg-white rounded-full transition-all duration-300 ${
                isHovered ? "w-1.5 h-1.5 opacity-100" : "w-1 h-1 opacity-80"
              } top-1/5 left-1/5`}
              style={{
                animation: isHovered
            ...
            ></div>
            <div
              className={`particle particle-2 absolute bg-white rounded-full transition-all duration-300 ${
                isHovered ? "w-1.5 h-1.5 opacity-100" : "w-1 h-1 opacity-80"
              } top-9/12 right-1/4`}
              style={{
                animation: isHovered
            ...
            ></div>
            <div
              className={`particle particle-3 absolute bg-white rounded-full transition-all duration-300 ${
                isHovered ? "w-1.5 h-1.5 opacity-100" : "w-1 h-1 opacity-80"
              } bottom-1/4 left-3/5`}
              style={{
                animation: isHovered
          ...
          {/* Arka plan blur efekti - hover'da daha güçlü */}
          <div
            className={`absolute inset-0 rounded-xl blur-lg transition-all duration-500 ${
              isHovered ? "opacity-90 scale-125" : "opacity-60 scale-100"
            }`}
            style={{
              background: `conic-gradient(
                from 0deg at 50% 50%,
