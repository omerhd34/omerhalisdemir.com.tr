  ...
  <section id="projects" className="relative mt-20 min-h-screen">
   ...
   <div className="min-h-screen relative overflow-hidden text-primary ">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10 ">
     ...
     {/* Quick Stats */}
     <div
      className={`text-center mb-8 xs:mb-10 sm:mb-12 transition-all duration-1000 delay-200 ${isVisible
       ? "opacity-100 translate-y-0"
       : "opacity-0 translate-y-10"
       }`}
     >
     ...
     {/* Category Tabs */}
     <div
      className={`flex flex-wrap justify-center gap-3 sm:gap-4 mb-5 xs:mb-10 sm:mb-12 transition-all duration-1000 delay-300 ${isVisible
       ? "opacity-100 translate-y-0"
       : "opacity-0 translate-y-10"
       }`}
     >
        ...
        {filteredProjects.map((project, index) => {
         ...
         return (
          <div
           ...
           style={{
            animation: `slideIn 0.6s ease-out ${index * 200
             }ms both`,
           }}
          >
           {/* Main Content */}
